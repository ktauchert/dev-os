...
| Doc | Use when |
| --- | --- |
| [vision.md](./vision.md) | Why DevOS exists and how we should build it |
| [mvp.md](./mvp.md) | What is in / out of the first release |
| [plan.md](./plan.md) | Current milestone and checklist |
| [aws-dev-workflow.md](./aws-dev-workflow.md) | **AWS build order, environments, MSW vs real API** |
| [future.md](./future.md) | Post-MVP ideas only—not scope |
